class WebDrawingExtension {
    ...
    showRipplePicker(anchorBtn) {
        ...
        const options = [
            ...
            { type: 'highlight', label: 'Viền trắng', color: '#ffffff', preview: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none"><circle cx="12" cy="12" r="8" stroke="#999" stroke-width="2" stroke-dasharray="2 2"/></svg>' },
            ...
            { type: 'ring', label: 'Xanh lá', color: '#34c759', preview: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#34c759" stroke-width="2.5"><circle cx="12" cy="12" r="4"/><circle cx="12" cy="12" r="9" opacity="0.4"/></svg>' },
            ...
            { type: 'glow', label: 'Xanh ngọc', color: '#06b6d4', preview: '<svg width="20" height="20" viewBox="0 0 24 24"><circle cx="12" cy="12" r="6" fill="#06b6d4" opacity="0.8"/><circle cx="12" cy="12" r="10" fill="#06b6d4" opacity="0.2"/></svg>' },
            ...
            { type: 'burst', label: 'Xanh lá', color: '#22c55e', preview: '<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#22c55e" stroke-width="2" stroke-linecap="round"><circle cx="12" cy="12" r="2" fill="#22c55e"/><line x1="12" y1="3" x2="12" y2="7"/><line x1="12" y1="17" x2="12" y2="21"/><line x1="3" y1="12" x2="7" y2="12"/><line x1="17" y1="12" x2="21" y2="12"/></svg>' },
        ];
